...
ComGyroAndAccelData gyroAndAccelData;
ComGyroAndAccelData offsetGyroAndAccelData;
...
void Com_Config_PrintMPU6050(uint8_t *pre, ComGyroAndAccelData *data){
    printf("%s accelX = %d, accelY = %d, accelZ = %d, gyroX = %d, gyroY = %d, gyroZ = %d\r\n", 
        pre, data->accelX, data->accelY, data->accelZ, 
