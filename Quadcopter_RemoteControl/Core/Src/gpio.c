...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, OLED_CS_Pin|OLED_SDA_Pin|SI24R1_CS_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(OLED_CLK_GPIO_Port, OLED_CLK_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, OLED_RES_Pin|OLED_DC_Pin|POWER_KEY_Pin|SI24R1_CE_Pin, GPIO_PIN_SET);

  /*Configure GPIO pins : OLED_CS_Pin OLED_CLK_Pin OLED_SDA_Pin */
  GPIO_InitStruct.Pin = OLED_CS_Pin|OLED_CLK_Pin|OLED_SDA_Pin;
